...
const DUMMY_RECIPE_INFO = {
  ...
  extendedIngredients: [
    ...
    },
    {
      ...
      originalName:
        'each coarsely chopped parsley, fresh mint leaves (or 2 tablespoons dried mint), and fresh dill (or 2 tablespoons dried dill)',
      amount: 0.5,
      unit: 'cup',
      meta: [
        'dried',
    ...
    },
    {
      ...
      originalName:
        'pork Italian sausages (about 8 oz. total), casings removed',
      amount: 2,
      unit: '',
      meta: ['italian', '( 8 oz. total)'],
      measures: {
        us: {
          amount: 2,
          unitShort: '',
    ...
    },
    {
      ...
      originalName:
        'lamb rib racks, 8 ribs each (4 1/2 to 5 lb. total; see notes)',
      amount: 2,
      unit: '',
      meta: [],
      measures: {
...
const RecipeDetals = (props) => {
  ...
  const addItem = (id, title) => {
    dispatch(
      favoritesActions.addToFavorites({ category: 'recipe', id, title })
    );
  };
  ...
  return (
    <RecipePageStyle>
      ...
      <StyledButton onClick={() => addItem(recipeInfo.id, recipeInfo.title)}>
        Add To Favorites
      </StyledButton>
    </RecipePageStyle>
  );
